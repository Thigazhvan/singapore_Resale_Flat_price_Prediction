...
def predict_price(year,month,town,flat_type,flr_area_sqm,flat_model,stry_start,stry_end,re_les_year,
    ...
    with open(r"C:/Users/MY COMPUTER/Desktop/Singapore Realestate Price Preditcion/Regression_Model.pkl","rb") as f:
        regg_model= pickle.load(f)

    user_data = np.array([[year_1,month_1,town_2,flt_ty_2,flr_ar_sqm_1,
...
st.title(":green[Singapore Resale Flat Price Prediction | by Thigazhvan]")
st.write("")


select= option_menu("Menu",["About the Project", "Price Prediction"])
...
if select == "About the Project":
    ...
    with col1:
        st.image("C:/Users/MY COMPUTER/Desktop/Singapore Realestate Price Preditcion/python.png")
    with col2:
        st.image("C:/Users/MY COMPUTER/Desktop/Singapore Realestate Price Preditcion/download.png")
    with col3:
        st.image("C:/Users/MY COMPUTER/Desktop/Singapore Realestate Price Preditcion/streamlit.png")
    ...
    if button:
        ...
        pre_price= predict_price(year, month, town, flat_type, flr_area_sqm, flat_model,
                        stry_start, stry_end, re_les_year, re_les_month, les_coms_dt)

        st.write("## :green[**The Predicted Resale Price is :**]",pre_price)
